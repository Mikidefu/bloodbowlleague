...
export default function SeasonsPage() {
  ...
  return (
      <div>
        ...
        {showWizard && (
            <section className={`card ${styles.wizard}`} aria-labelledby="wizard-title">
              ...
              <div className={styles.step}>
                <h3 className={`subhead ${styles.stepTitle}`}>
        ...
        <div className={styles.seasonList}>
          {seasons.map(season => {
            ...
            return (
                <article key={season.id} className={`card ${styles.seasonCard} ${isActive ? styles.seasonCardActive : ''}`}>
                  <div className={styles.cardTop}>
                    <span className="page-tab">#{season.number}</span>
                    <span className={`tag ${isActive ? 'tag-red' : 'tag-navy'}`}>
                  ...
                  <div className={styles.champion}>
                    ...
                    ) : <span className={styles.championCoach}>{t.seasons.noChampion}</span>}
                  </div>

                  <div className={styles.cardActions}>
                    <button className={`btn btn-navy ${styles.smallBtn}`} onClick={() => viewSeason(season)}>
                      {t.seasons.view}
                    </button>
